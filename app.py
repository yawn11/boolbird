...
if button_clicked:
    ...
    if True:
        ...
        color_bar_style = f'background-color: #89BF6C; height: 8px; width: {color_width-5}%; display: inline-block;'
        green_bar_style = f'background-color: #E4F4CF; height: 8px; width: {100-color_width-5}%; display: inline-block;'
